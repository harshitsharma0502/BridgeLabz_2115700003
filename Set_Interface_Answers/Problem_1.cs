...
class Program
{
    ...
    static void Main()
    {
        ...
        HashSet<int> set1 = new HashSet<int>(Console.ReadLine().Split(' ').Select(x => Convert.ToInt32(x)));

        Console.Write("Enter elements of Set2 separated by space: ");
        HashSet<int> set2 = new HashSet<int>(Console.ReadLine().Split(' ').Select(x => Convert.ToInt32(x)));
