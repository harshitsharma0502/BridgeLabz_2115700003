...
public class UniversityManagement
{
    public static void Main(string[] args)
    {
        ...
        // Display information
        Console.WriteLine(string.Format("{0} enrolled in {1}", student1.Name, course1.CourseName));
        Console.WriteLine(string.Format("{0} enrolled in {1}", student2.Name, course1.CourseName));
        Console.WriteLine(string.Format("{0} is teaching {1}", professor1.Name, course1.CourseName));
    }
}
